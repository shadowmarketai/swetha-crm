 ...
 * Swetha CRM: No marketing/whiteLabel/templates, added quotation
 */
...
const PERMISSION_MATRIX = {
  admin: {
    ...
    quotation: new Set(['create', 'read', 'update', 'delete']),
  },
  manager: {
    crm: new Set(['create', 'read', 'update', 'delete']),
    voiceAI: new Set(['create', 'read', 'update', 'delete']),
  ...
  agent: {
    ...
    inbox: new Set(['create', 'read', 'update']),
    webhooks: new Set([]),
    quotation: new Set(['create', 'read', 'update']),
  },
  user: {
    crm: new Set(['read']),
