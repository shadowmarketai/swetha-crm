...
const moduleRoutes = {
  ...
  quotation: {
    ...
    subNav: [
      ...
      { path: '/quotation/inbox', label: 'Review Inbox' },
      { path: '/quotation/ai', label: 'AI Quote' },
      ...
      { path: '/quotation/material-cost', label: 'Material Cost' },
      { path: '/quotation/history', label: 'History' },
      { path: '/quotation/logs', label: 'Audit Logs' },
    ],
  },
  appointments: {
    path: '/appointments',
