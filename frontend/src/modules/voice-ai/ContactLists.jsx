...
export default function ContactListsPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Bulk select banner */}
      {selectedIds.size > 0 && (
        <div className="flex items-center justify-between px-6 py-2.5 bg-indigo-50 dark:bg-indigo-900/20 border-b border-indigo-100 dark:border-indigo-800/40">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-lg text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-lg text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 transition-colors"
            >
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-700/50">
              {paginated.map(list => {
                ...
                return (
                  <tr
                    key={list.id}
                    className={`transition-colors ${isSelected ? 'bg-indigo-50/50 dark:bg-indigo-900/10' : 'hover:bg-slate-50 dark:hover:bg-slate-800/50'}`}
                  >
                    {/* Checkbox */}
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center flex-shrink-0">
                          <ListIcon className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
                        </div>
                        <span className="font-medium text-slate-900 dark:text-white truncate max-w-[200px]">{list.name}</span>
                      </div>
                    </td>

                    {/* Contacts */}
                    <td className="px-4 py-3">
                      <span className="font-semibold text-slate-700 dark:text-slate-300">{list.contacts.toLocaleString()}</span>
                    </td>
                    ...
                    {/* Created */}
                    <td className="px-4 py-3 text-slate-500 dark:text-slate-400 whitespace-nowrap">{list.created}</td>

                    {/* Last Used */}
                    <td className="px-4 py-3 text-slate-500 dark:text-slate-400 whitespace-nowrap">{list.lastUsed}</td>
      ...
      <div className="flex items-center justify-between px-6 py-3 border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-600 text-slate-500 hover:bg-slate-50 dark:hover:bg-slate-800 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
