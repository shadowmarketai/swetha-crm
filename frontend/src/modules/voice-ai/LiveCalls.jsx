...
export default function LiveCallsPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)]">
      ...
      <div className="flex items-center justify-between mb-4 flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium border border-slate-200 dark:border-slate-700 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
          >
            Auto-refresh: ON
          </button>
        </div>
      ...
      {/* ── Three-Column Layout ──────────────────────────────── */}
      <div className="flex flex-1 gap-0 overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
          ...
          <div className="p-3 border-b border-slate-200 dark:border-slate-700">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg text-sm text-slate-900 dark:text-white placeholder-slate-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"
              />
            </div>
          </div>
              ...
              filteredCalls.map((call) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-3 border-b border-slate-100 dark:border-slate-700/50 transition-colors ${
                      isSelected
                  ...
                  >
                    <div className="flex items-start justify-between mb-1.5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-sm text-slate-900 dark:text-white truncate">{call.name}</span>
                      </div>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {!selectedCall ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
              ...
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Select a call to view details</h3>
            ...
            <>
              {/* Sticky Header */}
              <div className="flex-shrink-0 px-5 py-3 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      ...
                      <span className="absolute -top-0.5 -right-0.5 w-3 h-3 bg-emerald-500 rounded-full border-2 border-white dark:border-slate-800 animate-pulse" />
                    </div>
                    <div>
                      <h2 className="font-semibold text-slate-900 dark:text-white">{selectedCall.name}</h2>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 dark:bg-slate-700 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors"
                    >
                      ...
                      <div className={`max-w-[75%] ${isAgent ? 'order-1' : 'order-1'}`}>
                        ...
                        <div
                          className={`rounded-2xl px-4 py-2.5 border-l-3 ${
                            isAgent
                              ? `bg-indigo-50 dark:bg-indigo-900/20 text-slate-800 dark:text-slate-200 ${emotionColors[msg.emotion] || ''} rounded-tl-md`
                              : `bg-slate-100 dark:bg-slate-700 text-slate-800 dark:text-slate-200 ${emotionColors[msg.emotion] || ''} rounded-tr-md`
                          }`}
                        >
              ...
              <CollapsibleSection title="Dialect Analysis" defaultOpen={true} badge={selectedCall.dialect}>
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm font-medium text-slate-900 dark:text-white">{selectedCall.language}</span>
                  </div>
                </div>
              </CollapsibleSection>
              ...
              >
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 text-xs rounded-full font-medium">
              ...
              <CollapsibleSection title="Call Metadata" defaultOpen={false}>
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-slate-900 dark:text-white capitalize">{selectedCall.direction}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-500 flex items-center gap-1.5">
                      <Bot className="w-3.5 h-3.5 text-indigo-500" />
                    ...
                    <span className="font-medium text-slate-900 dark:text-white">{selectedCall.agent}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-500 flex items-center gap-1.5">
                    ...
                    <span className="font-medium text-slate-900 dark:text-white text-right text-xs">{selectedCall.campaign}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-500 flex items-center gap-1.5">
                    ...
                    <span className="font-medium text-slate-900 dark:text-white">{selectedCall.topic}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-500 flex items-center gap-1.5">
                    ...
                    <span className="font-medium text-slate-900 dark:text-white">{selectedCall.startTime}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-500 flex items-center gap-1.5">
                      <Clock className="w-3.5 h-3.5 text-slate-400" />
                    ...
                    <span className="font-medium text-slate-900 dark:text-white font-mono">{selectedCall.duration}</span>
                  </div>
                </div>
              </CollapsibleSection>
            </div>
