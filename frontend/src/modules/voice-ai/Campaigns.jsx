...
const ProgressBar = ({ value, size = 'sm' }) => {
  ...
  return (
    <div className="flex items-center gap-2">
      <div className={`flex-1 ${height} bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden`}>
  ...
  return (
    <>
      <div className="flex items-start justify-between mb-2">
        <div>
          <h4 className="font-semibold text-sm text-slate-900 dark:text-white">{campaign.name}</h4>
      ...
      <div className="grid grid-cols-4 gap-1.5 mb-3">
        {[
          { label: 'Total', value: campaign.total, color: 'text-slate-900 dark:text-white' },
          ...
          <div key={stat.label} className="bg-slate-50 dark:bg-slate-900/50 rounded-lg px-1.5 py-1.5 text-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center bg-slate-100 dark:bg-slate-800 rounded-lg p-0.5">
            ...
            <button
              ...
              className={`p-2 rounded-md transition-colors ${viewMode === 'table' ? 'bg-white dark:bg-slate-700 shadow-sm text-indigo-600' : 'text-slate-500 hover:text-slate-700'}`}
              title="Table view"
            >
                ...
                <tr className="bg-slate-50 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-700">
                  {[
                    ...
                    <th
                      ...
                      className="px-4 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider cursor-pointer hover:text-slate-700 dark:hover:text-slate-300 select-none"
                    >
                ...
                {sortedCampaigns.length === 0 ? (
                  ...
                  sortedCampaigns.map((c) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-slate-600 dark:text-slate-400">{c.agent}</td>
                      <td className="px-4 py-3"><StatusBadge status={c.status} /></td>
                      <td className="px-4 py-3 text-slate-900 dark:text-white font-medium tabular-nums">{c.total.toLocaleString()}</td>
          ...
          <div className="relative w-full max-w-md bg-white dark:bg-slate-900 h-full overflow-y-auto shadow-2xl animate-slide-in-right">
            ...
            <div className="sticky top-0 z-10 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-slate-900 dark:text-white">{selectedCampaign.name}</h2>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-slate-900 dark:text-white">{selectedCampaign.startDate}</p>
                ...
                <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-slate-900 dark:text-white">{selectedCampaign.contactList}</p>
              ...
              <CollapsibleSection title="Progress" badge={`${selectedCampaign.progress}%`}>
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {[
                      { label: 'Total', value: selectedCampaign.total, icon: Users, color: 'text-slate-600 bg-slate-50 dark:bg-slate-800' },
                      { label: 'Called', value: selectedCampaign.called, icon: Phone, color: 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' },
                      { label: 'Connected', value: selectedCampaign.connected, icon: PhoneCall, color: 'text-emerald-600 bg-emerald-50 dark:bg-emerald-900/20' },
                      { label: 'Converted', value: selectedCampaign.converted, icon: CheckCircle, color: 'text-amber-600 bg-amber-50 dark:bg-amber-900/20' },
                    ].map((stat) => (
              ...
              <CollapsibleSection title="GenZ Analytics" badge={selectedCampaign.genZMode ? 'ON' : 'OFF'}>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-700 dark:text-slate-300">GenZ Mode</span>
                    <span className={`px-2 py-0.5 rounded text-xs font-medium ${selectedCampaign.genZMode ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-slate-100 text-slate-500 dark:bg-slate-700 dark:text-slate-400'}`}>
              ...
              <div className="grid grid-cols-2 gap-2 pt-4">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2.5 border border-slate-200 dark:border-slate-600 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2.5 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-lg text-sm font-medium hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors"
                >
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setShowCreateModal(false)}>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              {/* Agent */}
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">AI Agent</label>
                <select
              ...
              {/* Contact List */}
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Contact List</label>
                <select
              ...
              {/* Schedule */}
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Schedule Start</label>
                <input
                  type="datetime-local"
              ...
              {/* Target Dialect */}
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Target Dialect Preference</label>
                <select
              ...
              {/* Emotion Strategy */}
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Emotion Strategy</label>
                <select
              ...
              <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
                ...
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${newCampaign.genZMode ? 'bg-indigo-600' : 'bg-slate-300 dark:bg-slate-600'}`}
                >
                  <span
